...
run cd /opt/converter && git clone https://github.com/seleythen/ldbc-snb-impls && cd ldbc-snb-impls && git pull && wget https://bintray.com/repo/downloadMavenRepoSettingsFile/downloadSettings?repoPath=%2Fldbc%2Fsnb -O settings.xml && mvn install --projects snb-interactive-core --projects snb-interactive-neo4j -am -s settings.xml
